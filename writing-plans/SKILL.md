...
**Test Logic (what to verify, not code):**
- Verify that function returns expected output for valid input
- Verify that function handles edge case X correctly
- Verify that function raises appropriate error for invalid input Y
